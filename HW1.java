...
public class HW1 {
	 ...
	 */
	public static String encrypt_file(String fileIn) {
		String cipherText = "";
		for (int i = 0; i < fileIn.length()/8; i++) {

			//Parse out each 8 bit string from the main string
			String eightBit = fileIn.substring(i*8, (i+1) * 8);
	 ...
	 */
	public static String decrypt_file(String fileIn) {
		String plainText = "";
		for (int i = 0; i < fileIn.length()/8; i++) {
	...
	public static void main(String[] args) {
		...
		String plainBinary = convert_to_binary(data);

		// Input key for encryption/decryption
		String keyText = "1100011110";
		...
		String cipherText = encrypt_file(plainBinary);
		...
		String plainText = decrypt_file(cipherBinary);
